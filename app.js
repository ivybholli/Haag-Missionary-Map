...
function setupControls(){
  ...
  document.getElementById("searchInput").addEventListener("input",e=>{activeSearch=e.target.value;drawMarkers();});
  ...
  document.addEventListener("click",e=>{
    ...
    if(chip){selectedCountryForStats=chip.dataset.country||"";updateStats(getFilteredData());return;}
  });
